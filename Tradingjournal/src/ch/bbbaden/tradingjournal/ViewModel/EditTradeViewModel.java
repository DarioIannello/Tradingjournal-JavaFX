 ...
 * @author Dario
 */
public class EditTradeViewModel extends ViewModel implements PropertyChangeListener {
    ...
    public EditTradeViewModel(Model model) {
        this.model = model;
    }
    ...
    public void update(String pair, String bs, String date, String time, String wbel, String strat, String profit, String reasonsF, String reasonsA, String others, String learn) {
        model.update(pair, bs, date, time, wbel, strat, profit, reasonsF, reasonsA, others, learn);
    }
